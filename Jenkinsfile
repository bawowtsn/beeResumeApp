     ...
     stages {
        ...
        stage("Deploy") {
            steps {
                ...
                sh "sudo rsync --rsync-path='sudo rsync' -azvv -e 'ssh -i TDA_key_pair.pem' ${WORKSPACE}/build/* ec2-user@ec2-54-152-218-119.compute-1.amazonaws.com:/usr/share/nginx/html"
            }
        }
    }
}